    ...
    public partial class addEntities : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PropertyInFavorites", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PropertyInFavorites_Favorites_FavoriteId",
                        column: x => x.FavoriteId,
                        principalTable: "Favorites",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_PropertyInFavorites_Properties_PropertyId",
                        column: x => x.PropertyId,
                        principalTable: "Properties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PropertyInFavorites_FavoriteId",
                table: "PropertyInFavorites",
                column: "FavoriteId");

            migrationBuilder.CreateIndex(
                name: "IX_PropertyInFavorites_PropertyId",
                table: "PropertyInFavorites",
                column: "PropertyId");
        }
